...
class RegistroDeArchivoForm(forms.ModelForm):
    # Definir los campos de fecha con input_formats para asegurarnos de que Django los acepte correctamente
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
            ...
            # Evitar que 'ubicacion' sea requerida a nivel de formulario
        self.fields['ubicacion'].required = False

        # Si es un nuevo registro, asignar fecha_archivo por defecto
